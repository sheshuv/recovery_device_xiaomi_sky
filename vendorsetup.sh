...
# 关于橙狐变量详见 fox_12.1/vendor/recovery/orangefox_build_vars.txt
	...
	# 自定义闪光灯路径，修复闪光灯
	export OF_FL_PATH1=/sys/devices/virtual/camera/factory_test_flash:rear_flash_0
	export OF_FL_PATH2=/sys/devices/virtual/camera/factory_test_flash:rear_flash_1
	...
	F=$(find "device" -maxdepth 2 -name "sky")
	# 修改启动画面背景色为#000000
