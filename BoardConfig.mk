...
OF_MAINTAINER := 'SheshuVadrevu'
#OF_FL_PATH1 := '/sys/class/camera/factory_test_flash/rear_flash'
#OF_USE_GREEN_LED := 0
#
OF_FLASHLIGHT_ENABLE := 0
#OF_FLASHLIGHT_PATH := "/sys/class/camera/factory_test_flash/rear_flash"
